...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('profiler', '0026_alter_cybercriminal_options_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='cybercriminal',
            name='name',
            field=models.CharField(blank=True, help_text='Middle name/s should be entered in full and not be represented by an initial', max_length=255, null=True),
        ),
        migrations.AlterField(
            model_name='cybercriminal',
            name='nationality',
